...
const pricingData = [
  ...
  },
  {
    ...
    price: 'от 50 000 ₽',
    note: 'стоимость указана за работы под ключ в базе: ИИ-лендинг, SEO-блог, Telegram. Подключение дополнительных соцсетей — +5 000 ₽ за каждую. Опционально: подписка за 5 000 ₽/мес после реализации.',
    type: 'one-time'
  },
  {
    id: 'P5',
