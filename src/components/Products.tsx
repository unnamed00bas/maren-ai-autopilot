...
const products = [
  {
    ...
    demoAction: { label: 'Записаться на Демо консультацию за 2000 ₽', url: 'https://t.me/promaren_support_bot' },
  ...
  },
  {
    ...
    effect: 'Рост аудитории и входящих без агрессии; первые касания превращаются в запросы. Ежедневные выходы без касаний, стабильная сетка, прозрачные ссылки-отчёты.',
    demos: [
      {
        category: 'ИИ-Лендинг',
        links: [
