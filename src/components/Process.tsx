...
const steps = [
  {
    ...
    cta: 'Посчитать экономию времени (бесплатно)',
    action: 'calc'
  },
  {
    icon: Rocket,
    ...
    cta: 'Заказать Демо Ассистента на 24 ч за 999 ₽',
    action: 'link',
    link: 'https://t.me/promaren_support_bot?text=Заказать+Демо+Ассистента+на+24+ч+за+999+р'
  },
  {
    icon: Settings,
    title: 'Онбординг',
...
const options = [
  {
    ...
    cta: 'Записаться на Демо консультацию (аудит) за 2000 ₽',
    link: 'https://t.me/promaren_support_bot?text=Записаться+на+Демо+консультацию+за+2000+р',
    badge: 'Опция A'
  },
  {
    icon: Video,
    ...
    cta: 'Заказать Демо видео-встречу за 499 ₽',
    link: 'https://t.me/promaren_support_bot?text=Заказать+Демо+видео-встречу+за+499+р',
    badge: 'Опция B'
  }
];
